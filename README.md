...
The browser sender normalizes the left stick axes to the ROS Joy convention:
pushing the left stick left sends `axes[0] > 0`, and pushing it up sends
`axes[1] > 0`, matching the default `teleop_twist_joy` configs.
